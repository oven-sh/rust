 ...
 * post-link checks included: a commit of oven-sh/bun's main, which pins the same rustc nightly
 * and LLVM release. A stale ref only makes the profile slightly less representative.
 */
export const BUN_REF = "c508647f35d052d2ef073359e2e2e02f92a99508";
